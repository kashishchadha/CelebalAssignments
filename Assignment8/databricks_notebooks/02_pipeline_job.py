...
def run_databricks_job(batch_id: str = "batch_01"):
    spark = get_spark_session(f"DatabricksMedallionJob_{batch_id}")
...
if __name__ == "__main__":
    batch = sys.argv[1] if len(sys.argv) > 1 else "batch_01"
    run_databricks_job(batch)
